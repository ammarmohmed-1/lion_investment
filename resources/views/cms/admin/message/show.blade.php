        ...
        <div class="details" style="margin-bottom: 1.5rem;">
            <div class="recentOrders">
                <form enctype="multipart/form-data">
                    ...
                    <button type="button" onclick="store( {{ $message->id }},{{ $message->client->id }})"
                        ...
                        <div style="margin-top: 1rem; margin-bottom: 1rem; display:block;">
                            <div style="display: flex; justify-content: space-between;">
                                <p class="mb-0" @if ($message->admin_id !== null) style="color:blue;" @endif>
                                    @if ($message->admin_id !== null) You @else {{$message->client->first_name .' '.$message->client->last_name}} @endif : {{ $message->message }}</p>
...
@section('script')
    <script>
        function store(message_id, client_id) {
            axios.post('/cms/admin/message', {
                ...
                .then(function(response) {
                    ...
                    window.location.href = '/cms/admin/message/' + message_id
                })
