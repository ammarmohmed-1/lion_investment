            ...
            <div class="navbar navbar-expand-lg flex-wrap">
                ...
                <div class="collapse navbar-collapse" id="investmentnavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item d-md-none login-signup" @auth('admin') hidden @endauth
                            @auth('client') hidden @endauth>
                            <a class="btn-navbar" href="javascript:void(0)" style="color: black"><span>Sign
                                    In</span></a>
                        </li>

                        <li class="nav-item d-md-none login-signup1" @auth('admin') hidden @endauth
                            @auth('client') hidden @endauth>
                            <a class="btn-navbar" href="javascript:void(0)" style="color: black"><span>Sign
                                    Up</span></a>
                        </li>
                        ...
                        @auth('admin')
                        <li class="nav-item d-md-none dashboard">
                            <a class="btn-navbar" style="color: black" href="{{ route('admin-home') }}">Dashboard</a>
                        </li>

                        @endauth
                        @auth('client')
                        <li class="nav-item  d-md-none">
                            <a class="btn-navbar" style="color: black;" href="{{ route('client-home') }}">Dashboard</a>
                        </li>

                        @endauth
                    </ul>

                    <ul class="navbar-nav nav-registration" id="nav-registration">
                        @auth('admin')
                            <li class="nav-item">
                        ...
                        <li style="margin-right: 1rem" class="nav-item login-signup" @auth('admin') hidden @endauth
                            @auth('client') hidden @endauth>
                            <a href="javascript:void(0)"><span>Sign In</span></a>
                        </li>

                        <li class="nav-item login-signup1" @auth('admin') hidden @endauth
                            @auth('client') hidden @endauth>
                    ...
                    <div class="footer-links wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.15s">
                        <div class="footer-brand">
                            ...
                            <p class="text mt-30 mb-30">
                                A leading company in the field of investing in the stock markets and cryptocurrencies we contribute to raising the financial level of our clients in a comfortable and safe and risk-free framework.
                            </p>
                        </div>
